 ...
 */
myTasksControllers.controller('taskListCtrl', ['$scope', '$rootScope', '$window', '$http', '$location', '$cookies', 'LoginSvc',
    function($scope, $rootScope, $window, $http, $location, $cookies, LoginSvc) {
